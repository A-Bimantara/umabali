...
<div class="rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition bg-white w-55">
    <div class="relative">
        <img src="images/ubud-resort.png" alt="{{ $title }}" class="h-48 w-full object-cover">
